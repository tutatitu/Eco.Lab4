...
#ifdef ECO_BCM283X
    pCMe->m_pIProperty->pVTbl->ProcessingByArgs(pCMe->m_pIProperty, ECO_MB_CHANNEL_PROPERTY_ARM, &buffer[0], 5, ECO_MB_CHANNEL_PROPERTY_GET_VC_MEMORY, 8, 8, 0, 0) ;
...
voidptr_t ECOCALLMETHOD CEcoVirtualMemory1Lab_623E1838_Alloc(/* in */ IEcoVirtualMemory1Ptr_t me, /* in */ uint64_t addrVirtual, /* in */ uint32_t size) {
    ...
    return (voidptr_t)(addrPage + ECO_MMU_VA_START);
}
